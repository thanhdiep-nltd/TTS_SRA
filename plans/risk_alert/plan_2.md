...
def serialize_student_data(student_id, db_connection_string):
    ...
    query_notes = f"""
        SELECT description_text, behavior_category 
        FROM fact_behavior_logs 
        WHERE student_id = '{student_id}' 
    ...
    # Trong môi trường thực tế, độ dốc sẽ được tính toán qua phương pháp hồi quy tuyến tính OLS
